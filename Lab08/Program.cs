...
namespace Lab08
{
    ...
    public static class Program
    {
        ...
        public static void Main()
        {
            ...
            SavePlot("result/p-1.png", "Вероятность простоя P0", "Интенсивность λ", "P0", x, theorP0.ToArray(), expP0.ToArray());
            SavePlot("result/p-2.png", "Вероятность отказа Pn", "Интенсивность λ", "Pn", x, theorPn.ToArray(), expPn.ToArray());
            SavePlot("result/p-3.png", "Относительная пропускная способность Q", "Интенсивность λ", "Q", x, theorQ.ToArray(), expQ.ToArray());
            SavePlot("result/p-4.png", "Абсолютная пропускная способность A", "Интенсивность λ", "A (заявок/сек)", x, theorA.ToArray(), expA.ToArray());
            SavePlot("result/p-5.png", "Среднее число занятых каналов k", "Интенсивность λ", "k", x, theorK.ToArray(), expK.ToArray());
